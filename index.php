...
switch (true) {
    ...
    default:
     ...
     /* Нужно добавить простую проверку формы. 
        Проверить, чтобы все поля были заполнены и чтобы пароль совпадал с подтверждением пароля. 
        Если данные введены неправильно - вывести сообщение об ошибке. 
        Проверку можно сделать через HTML атрибуты или простой JavaScript.*/ #79
}